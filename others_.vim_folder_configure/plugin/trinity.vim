...
" User interface for switching the TagList and the NERD tree

command! -nargs=0 -bar TrinityToggleTagListAndNERDTree
    \ call <SID>Trinity_ToggleTagListAndNERDTree()
